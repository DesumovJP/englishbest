...
- [ ] **Step 2.4.A:** "Додати/видалити учня з групи" (edit members) — чи є UI? Якщо лише на create — додати edit flow.
- [ ] **Step 2.4.B:** Видалити/архівувати групу.
...
9. **2.4.A + 2.4.B** — Edit group members + delete/archive group.
