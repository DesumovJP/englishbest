/**
 * GET  /api/groups  — list groups visible to the caller (scoped on backend).
 * POST /api/groups  — create a new group (teacher forced to caller).
 *
...
export async function GET(req: NextRequest) {
  ...
  const res = await fetch(`${BACKEND_URL}/api/groups${search}`, {
    method: 'GET',
