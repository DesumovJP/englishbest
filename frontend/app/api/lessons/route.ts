/**
 * GET  /api/lessons — list lessons (scoped server-side by role).
 * POST /api/lessons — create lesson (owner forced to caller; staff only).
 *
...
export async function GET(req: NextRequest) {
  ...
  const res = await fetch(`${BACKEND_URL}/api/lessons${search}`, {
    method: 'GET',
