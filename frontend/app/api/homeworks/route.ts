/**
 * GET  /api/homeworks  — list homework (scoped server-side by role).
 * POST /api/homeworks  — create homework (teacher forced to caller; staff only).
 *
...
export async function GET(req: NextRequest) {
  ...
  const res = await fetch(`${BACKEND_URL}/api/homeworks${search}`, {
    method: 'GET',
