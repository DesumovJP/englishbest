    ...
    <div className="min-h-dvh bg-surface-muted/60 flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-8 lg:py-12">
        <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-[1.05fr_1fr] gap-6 lg:gap-10 items-start">
          {/* ── LEFT: Demo accounts ── */}
          <aside className="order-2 lg:order-1 bg-surface rounded-3xl border border-border p-5 sm:p-7 flex flex-col gap-5">
            <div className="flex items-start gap-3">
              ...
              />
              <div>
                <h2 className="text-xl font-black text-ink tracking-tight">Тестові акаунти</h2>
                <p className="text-[12px] text-ink-muted mt-1 leading-relaxed">
                  По одному демо-акаунту на кожну роль. Натисни «Заповнити форму» або скопіюй вручну.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-2xl bg-primary/5 border border-primary/15 p-4 flex items-start gap-3">
              <span className="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-primary/15 text-primary-dark flex-shrink-0">
              ...
              <div className="text-[12px] text-ink leading-relaxed">
                <p className="font-black">Демо-середовище</p>
                <p className="text-ink-muted mt-0.5">
                  Дані в акаунтах ілюстративні та можуть періодично оновлюватись.
                </p>
              </div>
            </div>
          </aside>
